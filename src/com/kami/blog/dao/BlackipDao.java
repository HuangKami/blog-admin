...
public interface BlackipDao{
	 ...
	 * @return
	 */
    int updateBlackip(@Param("enti") Blackip value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBlackip(@Param("enti") Blackip value, @Param("assist") Assist assist);
}