...
public interface RoleprivilegeDao{
	 ...
	 * @return
	 */
    int updateRoleprivilege(@Param("enti") Roleprivilege value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyRoleprivilege(@Param("enti") Roleprivilege value, @Param("assist") Assist assist);
}